...
<head>
    ...
    <!--Estilo EtiquetasQR -->
    <link rel="stylesheet" href="../css/etiquetas_qr.css">
    <!--Estilo Datatables -->
...
<body class="<?php echo (isset($_COOKIE['darkmode']) && $_COOKIE['darkmode'] == 'true') ? 'darkmode' : ''; ?>">
    ...
    <!-- LIBRERÍA QRIOUS (Puedes descargarla o usar CDN) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/qrious/4.0.2/qrious.min.js"></script>
    <!-- Librería externa para generar QRs -->
    <script src="../js/etiquetas_qr.js"></script>
