...
if (isset($_GET['error']) && $_GET['error'] === 'sesion_duplicada') {
    $_SESSION['errores'][] = "Tu sesión se cerró porque ingresaste desde otro dispositivo o navegador.";
}
                ...
                <div class="card-login-animated">
                    <div class="information">
                        ...
                        <div class="info-childs">
                            <h2>SWAOS</h2>
                            <p>Sistema web de administración y punto de venta</p>
                        </div>
                    </div>
